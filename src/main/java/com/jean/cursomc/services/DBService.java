...
import com.jean.cursomc.domain.Pagamento;
import com.jean.cursomc.domain.PagamentoComBoleto;
import com.jean.cursomc.domain.PagamentoComCartao;
import com.jean.cursomc.domain.Pedido;
import com.jean.cursomc.domain.Produto;
...
import com.jean.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jeanrenneiro@gmail.com","7788183696",TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("7798185641","4488457773"));
		
		Endereco e1 =new Endereco(null, "Rua Pedro Alvares", "30", "apto 30", "Jardim Panorama", "87113110", cli1, c1);
		Endereco e2 =new Endereco(null, "Rua Pedro Paes", "20", "sala 30", "Centro", "8711115", cli1, c2);
		...
		Pedido ped2 = new Pedido(null,sdf.parse("10/09/2017 19:30"),cli1,e2);
